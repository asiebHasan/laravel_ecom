			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="pagination">
						...
						@else
							<a href="{{ $products->previousPageUrl() }}&per_page={{ $perPage }}" class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
						@endif
						...
						@for ($i = 1; $i <= $products->lastPage(); $i++)
							...
							@else
								<a href="{{ $products->url($i) }}&per_page={{ $perPage }}">{{ $i }}</a>
							@endif
						@endfor
					
						@if ($products->hasMorePages())
							<a href="{{ $products->nextPageUrl() }}&per_page={{ $perPage }}" class="next-arrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
						@else
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="{{ asset('assets/img/product/p1.jpg') }}" alt="" href="{{ route('products.detail', $product->id) }}">
								<div class="product-details" href="{{ route('products.detail', $product->id) }}">
									<h6>{{ $product->name }}</h6>
									<div class="price">
										<h6>$150.00</h6>
									...
									<div class="prd-bottom">
										...
										<a href="{{ route('products.detail', $product->id) }}" class="social-info">
